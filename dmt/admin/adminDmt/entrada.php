<?php
	...
	if(isset($_POST['btn_inserir']))
	{
		...
		$obj_estoque -> insertEntrada($_POST['cmb_pedal'], $_POST['txt_qtd']); //código e qtd
		unset($obj_estoque);
		...
		<div class="container">
			<div class="reg">
				...
				<form method="post">
					...
					<ul>
						<li class="text-info">Quantidade de Entrada: </li>
						<li><input name="txt_qtd" type="number" class="inputform" min="1"></li>
					</ul>	
					<input name="btn_inserir" type="submit" value="Inserir no Estoque" style="background: #000066; color: #ffffff;">
				</form>	
			</div>
		</div>
	</div>
